...
INSERT INTO `recipe_main` VALUES (1,'Chicken Marsala',1,'Chicken and mushrooms',20,20,4,2,'Flatten chicken breats to 1/4 inch. Cook chicken in olive oil in a large skillet over medium heat for 3-5 minutes on each side or until the meat reaches a temparature of 170°. Remove chicken from skillet and keep warm.Use the same skillet to saute the mushrooms in butter until tender. Add the wine, parsley and rosemary. Bring mixture to a boil and cook until liquid is reduced by half. Serve chicken with mushroom sauce; sprinkle with cheese if desired.'),(2,'Absolute Brownies',2,'Rich, chcolate brownies',25,35,16,2,'Preheat oven to 350 degrees F (175 degrees C). Grease and flour an 8 inch square pan.In a large saucepan, melt 1/2 cup butter. Remove from heat, and stir in sugar, eggs, and 1 teaspoon vanilla. Beat in 1/3 cup cocoa, 1/2 cup flour, salt, and baking powder. Spread batter into prepared pan.Bake in preheated oven for 25 to 30 minutes. Do not overcook.To Make Frosting: Combine 3 tablespoons butter, 3 tablespoons cocoa, 1 tablespoon honey, 1 teaspoon vanilla, and 1 cup confectioners sugar. Frost brownies while they are still warm.');
UNLOCK TABLES;
-- Adding two new recipe:

LOCK TABLES `recipe_main` WRITE;
INSERT INTO `recipe_main` VALUES (4,'Apple cumble',4,'Fruity, Apple cumble',25,35,16,2,'Preheat oven to 300 degrees F (160 degrees C). Grease and flour an 8 inch square pan.In a large saucepan, melt 1/2 cup butter and apple pieces cut in small. Remove from heat, and stir in sugar, eggs, and 1 teaspoon vanilla. Beat in 1/3 cup of butter and biscuit crumbs and flatten on the square pan lines with foil. Add salt, and baking powder. Spread batter into prepared pan.Bake in preheated oven for 25 minutes. Do not overcook. Add maple syrup on top as frosting. Serve cold.'),(3,'Chickpea Marsala',3,'Chickpea and mushrooms',20,40,10,2,'Boil chickpea in cooker.Puree 4 tomatoes and sautee it in hot oil for 15 mins.Add spices and salt to add taste to the puree. Pour the boiled Chickpeas in the cooked tomato puree for 20-30 mins. Add the wine, parsley and rosemary. Bring mixture to a boil and cook until liquid is reduced by half. Serve chickpea with mushroom sauce; sprinkle with cheese if desired.');
UNLOCK TABLES;
--
...
LOCK TABLES `rec_ingredients` WRITE;
INSERT INTO `rec_ingredients` VALUES (17,3,100.0,20),(18,3,2,21),(19,3,2.00,3),(20,3,2.00,4),(21,3,2.00,5),(22,3,0.75,6),(23,3,0.25,8),(24,3,2.00,9),(25,3,2.00,10),(26,4,40,22),(27,4,4,23),(28,4,2.00,12),(29,4,1.00,13),(30,4,0.50,2),(31,2,0.25,15);
UNLOCK TABLES;
--
...
LOCK TABLES `ingredients` WRITE;
INSERT INTO `ingredients` VALUES (20,'Chickpeas'),(21,'Tomatoes'),(22,'Butter Biscuits'),(23,'apples');
UNLOCK TABLES;
--
...
LOCK TABLES `categories` WRITE;
INSERT INTO `categories` VALUES (3,'Entree'),(4,'Desserts');
UNLOCK TABLES;


select *
from recipe_main r
join rec_ingredients as i
on r.recipe_id = i.recipe_id
join ingredients ig
on i.ingredient_id = ig.ingredient_id
join categories c
on r.category_id = c.category_id
where r.recipe_id in (3,4);
